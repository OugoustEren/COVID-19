...
ggplot(din_dupl_muertes_ccaa) + geom_point(aes(fdate,dupl_t, color=CCAA)) +
  ...
  theme(legend.position="none") +
  scale_color_brewer(palette="Set1") +
  labs(y="Tiempo de duplicación de fallecidos (dias)", title="Tiempos de duplicaci en ventana movil de una semana antes de la fecha")
...
Otros basados, adeás en datos de movilidad geográfica:
